...
public abstract class SpriteBase {
    ...
    public void collidesWith( SpriteBase otherSprite) {

    	if(imageView.getBoundsInParent().intersects(otherSprite.imageView.getBoundsInParent()))
    	{
    		otherSprite.x-=10;
    		otherSprite.y-=10;
...
public void collidesWithT( SpriteBase otherSprite) {
    	if(imageView.getBoundsInParent().intersects(otherSprite.imageView.getBoundsInParent()))
    	{
    		
    		otherSprite.setRemovable(true);
    	}
    	
}
    public void collidesWithBullet( SpriteBase otherSprite) {
